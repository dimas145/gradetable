...
$string['countgraders'] = '{$a} grader';
$string['default'] = 'Enabled by default';
$string['default_help'] = 'If set, this feedback method will display the result of autograder feedbacks.';
$string['enabled'] = 'Autograding feedback';
